...
Syntax: my_list.count(value)  
Purpose: counts how many times a value occurs  
Changes: original list is unchanged  
Returns: an integer  
Order: does not change the list  
Duplicates: specifically counts duplicates  
